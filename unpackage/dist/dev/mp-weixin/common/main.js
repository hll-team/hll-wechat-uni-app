...
_App.default.mpType = 'app';var cuCustom = function cuCustom() {__webpack_require__.e(/*! require.ensure | components/colorui/components/cu-custom */ "components/colorui/components/cu-custom").then((function () {return resolve(__webpack_require__(/*! components/colorui/components/cu-custom.vue */ 65));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var hllTitle = function hllTitle() {__webpack_require__.e(/*! require.ensure | components/hll-title */ "components/hll-title").then((function () {return resolve(__webpack_require__(/*! components/hll-title.vue */ 70));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var hllHeader = function hllHeader() {__webpack_require__.e(/*! require.ensure | components/hll-header */ "components/hll-header").then((function () {return resolve(__webpack_require__(/*! components/hll-header.vue */ 77));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};




_vue.default.component('hll-title', hllTitle);
_vue.default.component('hll-header', hllHeader);
